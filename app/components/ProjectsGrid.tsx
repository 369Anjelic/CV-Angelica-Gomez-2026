...
export default function ProjectsGrid({ filter = 'all' }: { filter?: string }) {
  ...
  const [projects] = useState<Project[]>([
    ...
    },
    {
      ...
      icon: '🤖',
      title: 'IHK Lern Bot',
      description: 'KI-gestützter Lernbot für Anwendungsentwicklung mit strukturiertem Curriculum.',
      fullDescription: 'Ein intelligenter Lernbot speziell für IHK-Anwendungsentwickler mit interaktiven Lektionen, Übungsaufgaben, Codebeispielen und praktischen Herausforderungen zur Vorbereitung auf die IHK-Abschlussprüfung.',
      status: 'active',
      tech: ['Claude API', 'React', 'Next.js', 'TypeScript'],
    },
    {
      id: 7,
      icon: '💬',
